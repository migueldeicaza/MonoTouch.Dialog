...
{	
	...
	public partial class BadgeElement : Element, IElementSizing {
		...
		{
			CGPoint size = new CGPoint (tableView.Bounds.Width - 40, nfloat.MaxValue);
			//TODO:
//			CGSize height = tableView.StringSize (Caption.to, Font, size, LineBreakMode).Height + 10;
			
			// Image is 57 pixels tall, add some padding
			return Math.Max (0, 63);
		}
