...
namespace MonoTouch.Dialog
{
	public class DialogViewController : UITableViewController
	{
		...
		public void ReloadComplete ()
		{
            ...
            refreshView.Frame = new RectangleF(0, TableView.ContentSize.Height, TableView.ContentSize.Width, 60);
		...
		public class Source : UITableViewSource {
			...
			public override void Scrolled (UIScrollView scrollView)
			{
                ...
                Container.refreshView.Frame = new RectangleF(0, Container.TableView.ContentSize.Height, Container.TableView.ContentSize.Width, 60);
                
                var point = Container.TableView.ContentOffset;
			    point.Y += Container.TableView.Bounds.Height;
                Debug.WriteLine(String.Format("Flipped: {0}, Y: {1}, boundary: {2}", view.IsFlipped, point.Y, Container.TableView.ContentSize.Height+yboundary));
				if (view.IsFlipped && point.Y > Container.TableView.ContentSize.Height+yboundary){
					view.Flip (true);
					view.SetStatus (RefreshViewStatus.ReleaseToReload);
				} else if (!view.IsFlipped && point.Y < Container.TableView.ContentSize.Height+yboundary){
					view.Flip (true);
			...
			public override void DraggingEnded (UIScrollView scrollView, bool willDecelerate)
			{
                ...
                Debug.WriteLine(String.Format("Offset + Height: {0}, size + margin: {1}", Container.TableView.ContentOffset.Y + Container.TableView.Bounds.Height, Container.TableView.ContentSize.Height + yboundary));
                if (Container.TableView.ContentOffset.Y + Container.TableView.Bounds.Height > Container.TableView.ContentSize.Height + yboundary)
		...
		void ConfigureTableView ()
		{
			if (refreshRequested != null){
				...
				refreshView = MakeRefreshTableHeaderView (new RectangleF (0, -bounds.Height, bounds.Width, 100));
				if (reloading)
					refreshView.SetActivity (true);
